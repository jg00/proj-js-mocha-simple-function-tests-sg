...
// To use Mocha we just change test() to it().  Mocha is installed globally.
...
it("The map function", () => {
  ...
  assert.deepStrictEqual(result, [2, 7, 6]); // this function will look at all values inside of result
